...
do
  ...
  #log
  echo ""                 >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1
  echo "Runtime Iteration : $count Times, with executor config ${confVar} " >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1
  echo ""                 >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1
  ...
  echo "" >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1
  echo "" >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1
  echo "Run ${gcMode} mode, with ${Iter} Iteration"  >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1



  # run the application
	echo "spark-submit --class org.apache.spark.basic.SparkALS   --conf "${confVar}"  ${HOME}/jars/sparkapp_2.12-1.0.jar  ${Movies} ${Users} ${Features}   ${AppIterations} ${InputSlice}  "
  (time -p  spark-submit --class org.apache.spark.basic.SparkALS   --conf "${confVar}"  ${HOME}/jars/sparkapp_2.12-1.0.jar ${Movies} ${Users} ${Features}   ${AppIterations} ${InputSlice} ) >> "${HOME}/Logs/${tag}.InputSlice${InputSlice}.Iteration${AppIterations}.heapSize${heapSize}.LocalMemPecentage${CPUMemPercentage}.${gcMode}.parallelGC${ParallelGCThread}.${ConcGCThread}.log" 2>&1
